...
def generate_launch_description() -> LaunchDescription:
    ...
    # navigation_launch.py is sourced from this package instead (see below) — a
    # forked copy with corrected cmd_vel remaps. Everything else in this file
    # still resolves from the vendored nav2_bringup share dir unchanged.
