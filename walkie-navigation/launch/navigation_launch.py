    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                ...
                # was ('cmd_vel', 'cmd_vel_nav') — that bypassed velocity_smoother
                # and collision_monitor entirely (raw MPPI output straight to
                # cmd_vel_nav, the twist_mux navigation input / final drive topic)
            ...
            Node(
                ...
                parameters=[configured_params],
                arguments=['--ros-args', '--log-level', log_level],
                # was ('cmd_vel', 'cmd_vel_nav') — velocity_smoother's sub is
                # hardcoded to literal "cmd_vel", so this remap must point it at
                # controller_server's actual output, not its own downstream topic.
                remappings=remappings
            ...
            LoadComposableNodes(
                ...
                composable_node_descriptions=[
                    ComposableNode(
                        ...
                        parameters=[configured_params],
                        # was ('cmd_vel', 'cmd_vel_nav') — see plain-Node group above
                        remappings=remappings + [('cmd_vel', 'cmd_vel_controller')],
